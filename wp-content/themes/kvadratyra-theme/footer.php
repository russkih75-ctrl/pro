...
<footer class="site-footer">
    <div class="container">
        <div class="bento-grid" style="grid-template-columns: 2fr 1fr 1fr 1fr;">
            <!-- Column 1: Brand -->
            <div class="footer-col bento-card">
                <a href="<?php echo esc_url(home_url('/')); ?>" class="site-header__logo" style="margin-bottom: 16px;">
            ...
            <!-- Column 4: Contacts -->
            <div class="footer-col bento-card" itemscope itemtype="https://schema.org/HomeAndConstructionBusiness">
                <meta itemprop="name" content="<?php echo esc_attr(get_bloginfo('name')); ?>">
                <meta itemprop="url" content="<?php echo esc_url(home_url('/')); ?>">
                <div class="footer-col__title">Контакты</div>

                <?php $phone = kv_phone(); ?>
                <a href="tel:<?php echo esc_attr(kv_phone(false)); ?>" itemprop="telephone" style="font-weight: 700; color: var(--text); font-size: 18px; margin-bottom: 8px;"><?php echo esc_html($phone); ?></a>
                ...
                <?php if ($address) : ?>
                    <p class="footer-contact__item" itemprop="address" itemscope itemtype="https://schema.org/PostalAddress" style="margin-top: 12px;">
                ...
                <div class="footer-messengers" style="margin-top: 16px;">
