...
<div class="container" style="padding:24px 0;">
  ...
  <header style="margin:10px 0 18px;">
    <h1 style="font-size:36px;font-weight:900;letter-spacing:-0.02em;margin:0 0 10px;line-height:1.15;">Гайды по кровле, фасадам и заборам</h1>
    <p class="text-muted" style="max-width:900px;">Короткие практические инструкции, сравнения материалов и чек‑листы. Каждый гайд начинается с прямого ответа и даёт пошаговый план.</p>
  </header>
  ...
  ?>
    <div class="regions-grid" style="margin:14px 0 22px;">
      <a href="<?php echo esc_url(get_post_type_archive_link('guide')); ?>" style="border-color:rgba(232,197,71,0.35);color:var(--accent);">Все</a>
      ...
      <?php while (have_posts()) : the_post(); ?>
        <a href="<?php the_permalink(); ?>" class="card card--link blog-card">
          ...
          <div class="blog-card__body">
            ...
            <div class="blog-card__excerpt"><?php echo wp_trim_words(get_the_excerpt(), 20, '...'); ?></div>
          </div>
        </a>
      <?php endwhile; ?>
    </div>
  ...
  <?php else : ?>
    <div class="card" style="padding:28px;">
      <p class="text-muted">Пока нет гайдов. Начните с публикации первого гайда в админке: «Гайды → Добавить».</p>
    </div>
  <?php endif; ?>
